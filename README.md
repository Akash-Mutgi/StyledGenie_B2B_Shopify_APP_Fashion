...
- Shopify customer-account profile block extension for `My Style`
...
## Customer Account My Style

- `My Style` is implemented as a Shopify customer-account UI extension at
  [shopify/customer-style-profile-extension](/Users/akashmutgi/.codex/worktrees/d977/StyledGenie_B2B_Shopify_APP_Fashion/shopify/customer-style-profile-extension)
- the extension renders a new account-level style profile card on the Shopify customer Profile page
- persisted account-level data is served by:
  - `GET /api/customer/style-profiles`
  - `PUT /api/customer/style-profiles`
- storefront onboarding under `styledgenie-shopper-preferences-v1` remains separate and untouched
