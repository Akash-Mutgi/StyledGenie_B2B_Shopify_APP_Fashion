...
- Copy [shopify.app.production.toml](/Users/akashmutgi/.codex/worktrees/d977/StyledGenie_B2B_Shopify_APP_Fashion/shopify.app.production.toml) and replace:
  - `client_id`
  - `name`
  - `application_url`
  - `redirect_urls`
- Copy [.env.production.example](/Users/akashmutgi/.codex/worktrees/d977/StyledGenie_B2B_Shopify_APP_Fashion/.env.production.example) to your real production env file and replace:
  - `DEFAULT_MERCHANT_ID`
  - `SHOPIFY_APP_URL`
