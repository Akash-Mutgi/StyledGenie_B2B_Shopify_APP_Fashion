...
class LangChainService:
    ...
    def _merchant_voice_prompt(self, merchant_context: Optional[dict], *, audience: str) -> str:
        if isinstance(merchant_context, dict):
            voice_payload = merchant_context.get("chatbot_voice_config")
        else:
            voice_payload = None
        return self.merchant_voice_service.build_voice_system_prompt(voice_payload, audience=audience)
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                (
                    ...
                    f"{self._merchant_voice_prompt(merchant_context, audience='shopper-facing support concierge')}",
                ),
                (
                    "human",
                    "Shopper message: {shopper_message}\n"
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                (
                    ...
                    f"{self._merchant_voice_prompt(merchant_context, audience='shopper-facing stylist')}",
                ),
                (
                    "human",
                    "Shopper message: {shopper_message}\n"
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                (
                    ...
                    f"{self._merchant_voice_prompt(merchant_context, audience='shopper-facing inspiration stylist')}"
                ),
                (
                    "human",
                    "Shopper message: {shopper_message}\n"
